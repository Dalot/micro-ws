...
func (c *subscriberClient) Subscribe(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/backend.Subscriber/Subscribe", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSubscriberServer) Subscribe(context.Context, *SubscribeRequest) (*Response, error) {
...
func _Subscriber_Subscribe_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/backend.Subscriber/Subscribe",
	}
...
var Subscriber_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "backend.Subscriber",
